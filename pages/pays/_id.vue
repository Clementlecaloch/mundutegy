  ...
  <div class="container part">
    ...
    <div class="gallery" id="gallery">
      <div class="mb-3 pics animation all 2" v-for="image in pay.galerie.photos">
        <a class="img-fluid" :href="'https://afternoon-river-68648.herokuapp.com' + image.url" data-lightbox="galerie"><img class="image-galerie" :src="'http://localhost:1337' + image.url" alt=""></a>
      </div>
    </div>
